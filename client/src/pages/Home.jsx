...
const Home = () => {
  ...
  return (
    <div>
      ...
      <div className="grid grid-cols-3 px-24 mx-24">
        <div className="flex flex-col col-span-2 px-4  max-w-7xl sm:px-6 lg:px-8">
          ...
          <div className="flex flex-col">
            {userPosts.length > 0 ? (
              ...
              <div className="my-24  h-[400px] flex flex-col items-center justify-center">
                <svg
